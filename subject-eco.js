...
(function () {
  ...
  sections.synthese = `<div id="synthese" class="section active">
    ...
    <div class="synth-section">
      ...
      <div style="background:rgba(245,158,11,.10);border:1px solid #f59e0b;border-radius:10px;padding:12px 14px;margin:12px 0;">
        <p style="margin:0 0 6px;color:#fbbf24;font-weight:700;">❓ Que peut faire la Belgique face au risque de délocalisation ?</p>
        <p style="margin:0;">« Les <strong>entreprises de notre pays sont condamnées à être créatives et à se développer</strong>, la <strong>main-d'œuvre belge reconnue pour sa formation</strong>. »</p>
      </div>
      <div class="simple-exp-box">
        <button class="simple-exp-toggle" onclick="toggleSimpleExp(this)">📌 Définitions des 3 risques (par cœur)</button>
        <div class="simple-exp-content">
          <strong>Risque économique</strong> : perte d'emplois suite à la délocalisation.<br>
          <strong>Risque social</strong> : diminution de la solidarité (inégalités, mauvaises conditions de travail).<br>
          <strong>Risque environnemental</strong> : impact de l'activité de l'entreprise sur l'environnement (pollution, épuisement des ressources).
        </div>
      </div>
    </div>
    ...
    <div class="synth-section">
      ...
      <p>L'<strong>obligation</strong> est le <strong>lien de droit existant entre au moins deux personnes</strong> : le <strong>débiteur</strong> et le <strong>créancier</strong>.</p>
      <ul style="line-height:1.9;">
        <li><strong>Le débiteur</strong> = la personne <strong>qui doit</strong> (qui est tenue d'exécuter l'obligation).</li>
        <li><strong>Le créancier</strong> = la personne <strong>à qui on doit</strong> (envers qui l'obligation existe).</li>
        <li>L'<strong>objet</strong> de l'obligation = <strong>donner</strong>, <strong>faire</strong> ou <strong>ne pas faire</strong> quelque chose.</li>
      </ul>
      <div style="background:rgba(245,158,11,.10);border:1px solid #f59e0b;border-radius:10px;padding:12px 14px;margin:10px 0;">
        <p style="margin:0 0 6px;color:#fbbf24;font-weight:700;">Exemple : qui est le créancier et qui est le débiteur ?</p>
        <ul style="margin:0;line-height:1.9;">
          <li><strong>Obligation de payer le prix de vente</strong> : le <strong>créancier</strong> est le <strong>vendeur</strong>, le <strong>débiteur</strong> est l'<strong>acheteur</strong>.</li>
          <li><strong>Obligation de livrer l'objet vendu</strong> : le <strong>créancier</strong> est l'<strong>acheteur</strong>, le <strong>débiteur</strong> est le <strong>vendeur</strong>.</li>
          <li><strong>Obligation de réparer le dommage causé</strong> : le <strong>créancier</strong> est le <strong>préjudicié</strong> (la personne à qui le dommage a été causé), le <strong>débiteur</strong> est la personne qui a <strong>commis la faute</strong>.</li>
        </ul>
      </div>
      ...
      <ul style="line-height:1.9;">
        ...
        <li><strong>3. Les faits juridiques</strong> : un fait produit des effets de droit <strong>sans accord</strong>. On distingue :
          <ul style="line-height:1.9;">
            <li><strong>La responsabilité extracontractuelle</strong> : chaque fois qu'une personne cause, soit <strong>volontairement</strong> (un <strong>délit</strong> est commis), soit par <strong>négligence ou imprudence</strong> (un <strong>quasi-délit</strong> est commis), un <strong>dommage</strong> à autrui, elle engage sa <strong>responsabilité</strong> et est tenue à l'<strong>obligation de réparer le dommage causé</strong> : c'est la <strong>responsabilité délictuelle ou quasi-délictuelle</strong> (<strong>Livre 6</strong> du Code civil, <strong>art. 6.5</strong>).</li>
            <li><strong>Les quasi-contrats</strong> : définis par le Code civil comme des « <strong>faits purement volontaires de l'homme dont il résulte un engagement envers un tiers et quelquefois un engagement réciproque des parties</strong> ». <em>Exemple — la gestion d'affaires :</em> durant l'absence d'un de vos voisins, la tempête emporte une partie de la toiture de sa maison ; vous faites appel à un entrepreneur à qui vous payez le coût de la réparation. En ayant géré utilement l'affaire d'autrui en intervenant spontanément, vous devenez <strong>créancier</strong> de votre voisin pour le compte de qui vous avez agi.</li>
          </ul>
        </li>
      </ul>
    ...
    <div class="synth-section">
      ...
      <h3 style="color:#c4b5fd;margin:16px 0 6px">Comment naissent les servitudes ? (les sources)</h3>
      <ul style="line-height:1.9;">
        <li><strong>Les servitudes légales</strong> : elles sont établies <strong>par la loi</strong>. Elles peuvent être <strong>publiques</strong> (dans l'intérêt général) ou <strong>privées</strong> (entre voisins — ex. le passage en faveur d'un terrain <strong>enclavé</strong>).</li>
        <li><strong>Les servitudes conventionnelles</strong> : elles naissent d'un <strong>contrat</strong> (un accord entre les propriétaires). Pour être <strong>opposable aux tiers</strong>, l'acte doit être <strong>transcrit au bureau des hypothèques</strong>.</li>
        <li><strong>Les servitudes par prescription</strong> : un usage <strong>pendant 30 ans</strong> peut faire naître la servitude.</li>
      </ul>
      <h3 style="color:#c4b5fd;margin:16px 0 6px">Comment s'éteignent les servitudes ?</h3>
      <ul style="line-height:1.9;">
        <li><strong>Le non-usage pendant 30 ans</strong> (la prescription) : si la servitude n'est pas utilisée pendant <strong>30 ans</strong>, elle disparaît.</li>
        <li><strong>La confusion</strong> : le <strong>fonds dominant</strong> et le <strong>fonds servant</strong> deviennent la propriété d'<strong>une seule et même personne</strong> → la servitude n'a plus de raison d'être.</li>
        <li><strong>La renonciation</strong> du propriétaire du <strong>fonds dominant</strong>.</li>
        <li><strong>La perte d'utilité</strong> : la servitude devient <strong>inutile</strong>. <em>Ex. : une servitude de <strong>puisage d'eau</strong> s'éteint quand le fonds dominant est <strong>raccordé au réseau</strong> de distribution d'eau.</em></li>
      </ul>
      <p style="font-size:.92em;color:#9ca3af">Les servitudes sont réglées par les <strong>articles 3.114 à 3.137</strong> du Code civil (Livre 3 — Les biens).</p>
      <div class="simple-exp-box">
        <button class="simple-exp-toggle" onclick="toggleSimpleExp(this)">💡 Comprendre simplement</button>
        <div class="simple-exp-content">Ton terrain est « coincé » derrière celui du voisin, sans accès à la route ? La <strong>servitude de passage</strong> te donne le <strong>droit de traverser</strong> chez lui pour rejoindre la rue — sans racheter son terrain. Le terrain qui profite = <strong>dominant</strong> ; celui qui subit = <strong>servant</strong>. Une servitude peut <strong>naître</strong> (loi, contrat, 30 ans d'usage) et <strong>s'éteindre</strong> (30 ans sans usage, confusion, renonciation, perte d'utilité).</div>
      </div>
      ...
      <div class="key-rule"><div class="formula-main">Sources : loi · contrat (transcrit au bureau des hypothèques) · prescription 30 ans — Extinction : non-usage 30 ans · confusion · renonciation · perte d'utilité</div></div>
    </div>
    ...
    <div class="synth-section">
      ...
      <ul style="line-height:1.95;">
        <li><strong>① La confusion</strong> est la <strong>réunion sur la même tête des deux qualités de créancier et de débiteur</strong>, ce qui <strong>entraîne l'extinction de l'obligation</strong>. <em>Ex. : Monsieur Dubois emprunte 5 000 € à son père ; celui-ci décède et Monsieur Dubois est son seul héritier.</em></li>
        <li><strong>② La compensation</strong> est le <strong>mode d'extinction de deux obligations réciproques entre deux personnes jusqu'à concurrence de la dette la moins élevée</strong>. Pour qu'elle puisse s'effectuer, il faut que les <strong>deux obligations soient exigibles</strong>. <em>Ex. : Dubois doit 5 000 € à Durand ; Durand devient débiteur de 2 500 € (frais de réparation) → Dubois ne devra plus que 2 500 € à Durand.</em></li>
        <li><strong>③ La novation</strong> est une <strong>convention par laquelle on substitue à une obligation existante une obligation nouvelle</strong>. Elle peut se réaliser par le changement de <strong>débiteur</strong>, d'<strong>objet</strong> ou de <strong>créancier</strong>.</li>
        <li><strong>④ La remise de dette</strong> est une <strong>convention par laquelle le créancier abandonne volontairement tout ou partie de sa créance à l'égard de son débiteur</strong>.</li>
        <li><strong>⑤ La prescription</strong> est l'<strong>extinction de l'obligation au bout d'un certain temps</strong>. Le <strong>délai ordinaire est de 30 ans</strong> mais il existe des délais plus courts. <em>Ex. : 1 an pour les sommes dues par des particuliers à des commerçants pour la livraison de marchandise.</em></li>
      </ul>
  ...
  var questions = [
    ...
    { q: "Que peut faire la Belgique face au risque de delocalisation ?", opts: ["ses entreprises sont condamnees a etre creatives et a se developper (main-d'oeuvre reconnue pour sa formation)", "fermer ses frontieres au commerce", "interdire toutes les importations", "baisser les salaires sous le minimum"], ans: 0, chapter: "mondialisation", difficulty: "difficile", exp: "Reponse du cours : les entreprises de notre pays sont condamnees a etre creatives et a se developper, la main-d'oeuvre belge etant reconnue pour sa formation." },
    ...
    // ── Les sources des obligations (art. 5.1, 205, 6.5) ──
    { q: "Dans le cours, une obligation est :", opts: ["le lien de droit existant entre au moins deux personnes (un debiteur et un creancier)", "une simple promesse sans valeur", "une loi votee au parlement", "une decision de la police"], ans: 0, chapter: "obligations", difficulty: "intermediaire", exp: "Definition du cours : l'obligation est le lien de droit existant entre au moins deux personnes, le debiteur (qui doit) et le creancier (a qui on doit)." },
    { q: "Pour l'obligation de payer le prix de vente, le debiteur est :", opts: ["l'acheteur", "le vendeur", "le juge", "le notaire"], ans: 0, chapter: "obligations", difficulty: "intermediaire", exp: "Payer le prix : le debiteur (qui doit) est l'acheteur ; le creancier (a qui on doit) est le vendeur." },
    { q: "Pour l'obligation de livrer l'objet vendu, le debiteur est :", opts: ["le vendeur", "l'acheteur", "la banque", "l'assureur"], ans: 0, chapter: "obligations", difficulty: "intermediaire", exp: "Livrer l'objet : le debiteur (qui doit) est le vendeur ; le creancier (a qui on doit) est l'acheteur." },
    ...
    { q: "La responsabilité extracontractuelle (délit, quasi-délit) est une obligation née :", opts: ["d'un fait juridique", "d'un contrat", "de la loi seule", "d'un serment"], ans: 0, chapter: "obligations", difficulty: "intermediaire", exp: "Le délit/quasi-délit est un fait juridique : il oblige à réparer le dommage causé, même sans contrat (responsabilité extracontractuelle, Livre 6, art. 6.5)." },
    ...
    { q: "Le Code civil définit le quasi-contrat comme :", opts: ["des faits purement volontaires de l'homme dont il resulte un engagement envers un tiers", "un contrat signe devant notaire", "une faute qui cause un dommage", "une loi votee au parlement"], ans: 0, chapter: "obligations", difficulty: "difficile", exp: "Quasi-contrat = des faits purement volontaires de l'homme dont il resulte un engagement envers un tiers (et quelquefois un engagement reciproque des parties). On est engage sans avoir rien signe." },
    { q: "La gestion d'affaires (gerer la toiture d'un voisin absent apres une tempete) est :", opts: ["un quasi-contrat (fait juridique)", "un contrat de vente", "un delit", "une obligation legale"], ans: 0, chapter: "obligations", difficulty: "intermediaire", exp: "En gerant utilement l'affaire d'autrui en intervenant spontanement, vous devenez creancier de votre voisin : c'est un quasi-contrat, donc un fait juridique." },
    ...
    { q: "Quelles sont les sources (origines) des servitudes ?", opts: ["la loi, le contrat (conventionnelle), la prescription", "le juge, l'huissier, le notaire", "l'achat, la vente, la location", "le terme, la condition, la solidarite"], ans: 0, chapter: "servitudes", difficulty: "intermediaire", exp: "Une servitude peut etre legale (par la loi), conventionnelle (par contrat) ou nee par prescription (usage pendant 30 ans)." },
    { q: "Pour qu'une servitude conventionnelle soit opposable aux tiers, l'acte doit etre :", opts: ["transcrit au bureau des hypotheques", "publie dans le journal", "signe par le bourgmestre", "enregistre a la commune"], ans: 0, chapter: "servitudes", difficulty: "difficile", exp: "La servitude nait du contrat entre proprietaires, mais pour etre opposable aux tiers, l'acte doit etre transcrit au bureau des hypotheques." },
    { q: "Une servitude s'eteint notamment :", opts: ["par le non-usage pendant 30 ans", "apres 1 mois sans usage", "des que le voisin le demande", "uniquement par decision de justice"], ans: 0, chapter: "servitudes", difficulty: "intermediaire", exp: "Modes d'extinction : non-usage pendant 30 ans, confusion (un seul proprietaire), renonciation, perte d'utilite." },
    { q: "Le fonds dominant et le fonds servant deviennent la propriete d'une seule personne : la servitude s'eteint par :", opts: ["la confusion", "la prescription", "la renonciation", "la novation"], ans: 0, chapter: "servitudes", difficulty: "difficile", exp: "Confusion = les deux fonds se reunissent dans la meme main : la servitude n'a plus de raison d'etre." },
    { q: "Une servitude de puisage d'eau s'eteint quand le fonds est raccorde au reseau : c'est :", opts: ["la perte d'utilite", "la confusion", "la compensation", "la solidarite"], ans: 0, chapter: "servitudes", difficulty: "difficile", exp: "La servitude devient inutile : elle s'eteint par perte d'utilite." },
    ...
    { q: "La confusion, c'est :", opts: ["la reunion sur la meme tete des deux qualites de creancier et de debiteur", "quand le creancier oublie sa creance", "quand le debiteur demenage", "quand deux contrats se ressemblent"], ans: 0, chapter: "extinction", difficulty: "intermediaire", exp: "La confusion est la reunion sur la meme tete des deux qualites de creancier et de debiteur, ce qui entraine l'extinction de l'obligation (ex. on herite de son creancier)." },
    { q: "La compensation, c'est :", opts: ["l'extinction de deux obligations reciproques jusqu'a concurrence de la dette la moins elevee", "payer en plusieurs fois", "annuler un contrat", "transferer une dette a un tiers"], ans: 0, chapter: "extinction", difficulty: "intermediaire", exp: "La compensation est le mode d'extinction de deux obligations reciproques entre deux personnes jusqu'a concurrence de la dette la moins elevee (les deux obligations doivent etre exigibles)." },
  ...
  var flashcards = [
    ...
    { front: "Que peut faire la Belgique face au risque de délocalisation ?", back: "Les <strong>entreprises de notre pays sont condamnées à être créatives et à se développer</strong>, la <strong>main-d'œuvre belge reconnue pour sa formation</strong>.", chapter: "mondialisation" },
    ...
    { front: "Définition d'une obligation (cours) ?", back: "L'obligation est le <strong>lien de droit existant entre au moins deux personnes</strong> : le <strong>débiteur</strong> (la personne qui doit) et le <strong>créancier</strong> (la personne à qui on doit).", chapter: "obligations" },
    { front: "Vente : qui est créancier / débiteur ?", back: "<strong>Payer le prix</strong> → créancier = le <strong>vendeur</strong>, débiteur = l'<strong>acheteur</strong>.<br><strong>Livrer l'objet vendu</strong> → créancier = l'<strong>acheteur</strong>, débiteur = le <strong>vendeur</strong>.", chapter: "obligations" },
    ...
    { front: "Délit vs quasi-délit ?", back: "<strong>Délit</strong> = faute <strong>volontaire / intentionnelle</strong>. <strong>Quasi-délit</strong> = faute <strong>non intentionnelle</strong> (négligence, imprudence). Les deux obligent à <strong>réparer le dommage causé</strong> : c'est la responsabilité <strong>délictuelle ou quasi-délictuelle</strong> (Livre 6, art. 6.5).", chapter: "obligations" },
    { front: "Qu'est-ce qu'un quasi-contrat ? (définition du cours)", back: "Des « <strong>faits purement volontaires de l'homme dont il résulte un engagement envers un tiers et quelquefois un engagement réciproque des parties</strong> ». On est engagé <strong>sans rien avoir signé</strong>.", chapter: "obligations" },
    { front: "Exemple de quasi-contrat : la gestion d'affaires ?", back: "Durant l'absence d'un voisin, la tempête emporte une partie de sa toiture ; vous appelez un entrepreneur que vous payez. En ayant <strong>géré utilement l'affaire d'autrui</strong> en intervenant spontanément, vous devenez <strong>créancier</strong> de votre voisin pour le compte de qui vous avez agi.", chapter: "obligations" },
    ...
    { front: "Quelles sont les sources des servitudes ?", back: "<strong>1. Légale</strong> (établie par la loi, publique ou privée) · <strong>2. Conventionnelle</strong> (par contrat ; transcrite au <strong>bureau des hypothèques</strong> pour être opposable aux tiers) · <strong>3. Par prescription</strong> (usage pendant <strong>30 ans</strong>).", chapter: "servitudes" },
    { front: "Comment une servitude s'éteint-elle ?", back: "<strong>Non-usage pendant 30 ans</strong> · <strong>confusion</strong> (un seul propriétaire pour les deux fonds) · <strong>renonciation</strong> du fonds dominant · <strong>perte d'utilité</strong> (ex. raccordement au réseau d'eau).", chapter: "servitudes" },
    { front: "Une servitude conventionnelle : comment la rendre opposable aux tiers ?", back: "Elle naît d'un <strong>contrat</strong> entre propriétaires, mais pour être <strong>opposable aux tiers</strong>, l'acte doit être <strong>transcrit au bureau des hypothèques</strong>.", chapter: "servitudes" },
    ...
    { front: "L'extinction par confusion ?", back: "La confusion est la <strong>réunion sur la même tête des deux qualités de créancier et de débiteur</strong>, ce qui entraîne l'<strong>extinction de l'obligation</strong>. <em>Ex. : Dubois emprunte 5 000 € à son père ; le père décède et Dubois est son seul héritier.</em>", chapter: "extinction" },
    { front: "L'extinction par compensation ?", back: "La compensation est le <strong>mode d'extinction de deux obligations réciproques entre deux personnes jusqu'à concurrence de la dette la moins élevée</strong> (les deux obligations doivent être <strong>exigibles</strong>).", chapter: "extinction" },
    { front: "L'extinction par novation ?", back: "La novation est une <strong>convention par laquelle on substitue à une obligation existante une obligation nouvelle</strong> : par changement de <strong>débiteur</strong>, d'<strong>objet</strong> ou de <strong>créancier</strong>.", chapter: "extinction" },
    { front: "L'extinction par remise de dette ?", back: "C'est une <strong>convention par laquelle le créancier abandonne volontairement tout ou partie de sa créance à l'égard de son débiteur</strong>.", chapter: "extinction" },
    { front: "L'extinction par prescription ?", back: "C'est l'<strong>extinction de l'obligation au bout d'un certain temps</strong> : délai ordinaire <strong>30 ans</strong> (parfois plus court, ex. <strong>1 an</strong> pour les sommes dues par des particuliers à des commerçants pour la livraison de marchandise).", chapter: "extinction" },
