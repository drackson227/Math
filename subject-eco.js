...
(function () {
  ...
  sections.synthese = `<div id="synthese" class="section active">
    ...
    <div class="synth-section">
      ...
      <ul style="line-height:1.9;">
        <li>une <strong>faute</strong> (ou un fait : une imprudence, une négligence, un acte) — appréciée par rapport au comportement d'une <strong>personne prudente et raisonnable</strong> (critère qui a remplacé celui du « bon père de famille ») ;</li>
        <li>un <strong>dommage</strong> (un préjudice subi par la victime) ;</li>
        <li>un <strong>lien de causalité</strong> entre les deux : d'après la <strong>théorie de la condition nécessaire</strong>, sans la faute le dommage ne se serait pas produit tel qu'il s'est produit.</li>
      </ul>
      <div class="eco-flow">
