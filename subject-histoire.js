/* GR2 Study — Contenu HISTOIRE (4ème)
   ...
   + compétence « critique de document ».
...
(function () {
  ...
  sections.synthese = `<div id="synthese" class="section active">
    ...
    <div class="synth-section">
      ...
      <ul style="line-height:1.9;">
        ...
        <li><strong>Moyen Âge</strong> : de 476 à <strong>1492</strong> (découverte de l'Amérique) — ou 1453 (chute de Constantinople).</li>
        <li><strong>Temps modernes</strong> : de 1492 à la <strong>Révolution française (1789)</strong>. ← <em>c'est notre programme.</em></li>
        <li><strong>Époque contemporaine</strong> : de 1789 à aujourd'hui.</li>
      </ul>
      <div class="key-rule"><div class="formula-main" style="font-size:18px;">1450 imprimerie · 1492 Amérique · 1517 Réforme · 1789 Révolution</div></div>
    </div>
    ...
    <div class="synth-section">
      ...
      <ul style="line-height:1.9;">
        ...
        <li>Les <strong>idées circulent vite</strong> dans toute l'Europe → l'imprimerie va diffuser l'<strong>Humanisme</strong> puis la <strong>Réforme</strong>.</li>
      ...
      <div class="simple-exp-box">
        ...
        <div class="simple-exp-content">L'imprimerie est le « internet » de l'époque : avant, copier un livre prenait des mois ; après, on en imprime des centaines. Du coup, une idée nouvelle (comme celle de Luther) peut se répandre partout en quelques semaines.</div>
      </div>
    </div>
    ...
    <div class="synth-section">
      ...
      <p><strong>Jean Calvin</strong> développe ensuite le protestantisme à Genève (idée de la <strong>prédestination</strong>). La chrétienté se <strong>divise</strong> : catholiques, <strong>protestants</strong> (luthériens, calvinistes), anglicans, orthodoxes.</p>
  ...
  var questions = [
    ...
    { q: "Le massacre de la Saint-Barthélemy (guerres de religion) a lieu en :", opts: ["1572", "1517", "1685", "1789"], ans: 0, chapter: "reforme", difficulty: "difficile", exp: "1572 : massacre de protestants en France pendant les guerres de religion." },
