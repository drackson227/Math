...
(function () {
  ...
  sections.formules = `<div id="formules" class="section">
    ...
    <div class="formula-grid">
      <div>
        <div class="formula-box"><h3>Convaincre vs Persuader</h3><div class="formula-main" style="font-size:15px;">Convaincre = par la raison (logique, preuves) · Persuader = par les émotions (sentiments)</div></div>
        <div class="formula-box"><h3>Texte argumenté</h3><div class="formula-main" style="font-size:15px;">Thème (le sujet) → thèse (l'opinion) → arguments (+ développement) → exemples</div><p style="line-height:1.9; margin:.6rem 0 0;">Le tout relié par des <strong>connecteurs logiques</strong>.</p></div>
        <div class="formula-box"><h3>Connecteurs logiques</h3><div class="formula-main" style="font-size:15px;">cause · conséquence · addition · opposition/concession · explication</div><p style="line-height:1.9; margin:.6rem 0 0;">Ex. : cause (<em>car, parce que</em>) · conséquence (<em>donc, ainsi</em>) · addition (<em>et, puis, enfin</em>) · opposition (<em>mais, or, cependant, certes</em>) · explication (<em>en effet, par exemple</em>).</p></div>
        <div class="formula-box"><h3>Réussir à convaincre</h3><div class="formula-main" style="font-size:15px;">Arguments recevables + opinion nuancée + concession → réfutation (« certes… mais… »)</div></div>
        <div class="formula-box"><h3>Vocabulaire du théâtre</h3><div class="formula-main" style="font-size:15px;">réplique · tirade · monologue · aparté · stichomythies · didascalies · quiproquo · double énonciation</div><p style="line-height:1.9; margin:.6rem 0 0;"><strong>tirade</strong> = longue réplique à un autre · <strong>monologue</strong> = parle seul · <strong>aparté</strong> = au public · <strong>stichomythies</strong> = répliques très courtes · <strong>didascalies</strong> = indications de jeu · <strong>double énonciation</strong> = personnages + public.</p></div>
        <div class="formula-box"><h3>Les 4 types de comique</h3><div class="formula-main" style="font-size:15px;">de mots · de gestes · de situation · de caractère</div></div>
        <div class="formula-box"><h3>Les 5 procédés comiques</h3><div class="formula-main" style="font-size:15px;">écart · renversement · glissement vers l'absurde · répétition · exagération</div></div>
        <div class="formula-box"><h3>Le lieu théâtral</h3><div class="formula-main" style="font-size:15px;">Scène : plateau · coulisses · côté cour = gauche du comédien · côté jardin = droite</div><p style="line-height:1.9; margin:.6rem 0 0;">Vu de la salle c'est inversé (jardin à gauche, cour à droite). <strong>Salle</strong> : orchestre · parterre · baignoire · corbeilles · poulailler (« paradis ») · loges.</p></div>
        <div class="formula-box"><h3>Structure d'une pièce</h3><div class="formula-main" style="font-size:15px;">exposition → (coup de théâtre) → nœud → dénouement</div><p style="line-height:1.9; margin:.6rem 0 0;">Découpage : <strong>actes</strong> (séparés par l'entracte) · tableaux/journées · scènes.</p></div>
        <div class="formula-box"><h3>Les métiers du théâtre</h3><div class="formula-main" style="font-size:15px;">dramaturge · comédien · tragédien · figurant · metteur en scène · régisseurs</div><p style="line-height:1.9; margin:.6rem 0 0;"><strong>dramaturge</strong> = l'auteur · <strong>tragédien</strong> = joue la tragédie · <strong>figurant</strong> = rôle muet.</p></div>
      </div>
      <div>
        <div class="formula-box"><h3>Compter les syllabes</h3><div class="formula-main" style="font-size:15px;">12 = alexandrin · 10 = décasyllabe · 8 = octosyllabe</div><p style="line-height:1.8; margin:.6rem 0 0;">Césure de l'alexandrin = 2 <strong>hémistiches</strong> de 6 syllabes. Le « e » muet en fin de vers ne compte pas.</p></div>
        <div class="formula-box"><h3>Disposition des rimes</h3><div class="formula-main" style="font-size:15px;">plates = AABB · croisées = ABAB · embrassées = ABBA</div></div>
        <div class="formula-box"><h3>Rimes : nature &amp; qualité</h3><div class="formula-main" style="font-size:15px;">Nature : féminine (« e » muet) / masculine · Qualité : pauvre (1 son) · suffisante (2) · riche (3+)</div></div>
        <div class="formula-box"><h3>Figures de style</h3><div class="formula-main" style="font-size:15px;">comparaison (avec « comme ») · métaphore (sans outil) · personnification · hyperbole · anaphore · allitération/assonance</div></div>
        <div class="formula-box"><h3>Le mythe</h3><div class="formula-main" style="font-size:15px;">Récit sacré, avec des êtres surnaturels, qui explique le monde (création, mort, foudre…) et transmet des valeurs</div><p style="line-height:1.9; margin:.6rem 0 0;">Oral à l'origine (<em>muthos</em> = « la parole »). Ex. : Genèse, Prométhée, Popol Vuh.</p></div>
        <div class="formula-box"><h3>Le résumé</h3><div class="formula-main" style="font-size:15px;">Réduire (≈ ¼) · reformuler avec ses mots · rester neutre (pas de « je ») · garder l'essentiel et l'ordre</div><p style="line-height:1.9; margin:.6rem 0 0;">Une énumération se remplace par un <strong>hyperonyme</strong> (mot général).</p></div>
  ...
  var flashcards = [
    ...
    { front: "Convaincre vs Persuader ?", back: "Convaincre = par la raison, avec des preuves et des arguments logiques (adhésion rationnelle). Persuader = par les émotions et les sentiments (adhésion émotionnelle).", chapter: "argumentation" },
    ...
    { front: "Thème / thèse / argument ?", back: "Thème = le sujet (de quoi on parle). Thèse = l'opinion défendue. Argument = une bonne raison qui soutient la thèse (souvent + un développement/exemple).", chapter: "argumentation" },    { front: "Le schéma argumentatif ?", back: "Thèse → Argument 1 (+ développement) → Argument 2 → Argument 3. L'ordre peut varier ; parfois il faut inférer la thèse ou un argument.", chapter: "argumentation" },
