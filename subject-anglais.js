...
(function () {
  ...
  var flashcards = [
    ...
    { front: "Que veut dire « Saint Patrick's Day » ?", back: "La fête nationale irlandaise, le 17 mars — on s'habille en vert partout dans le monde.", chapter: "vocab" },    { front: "already / yet / just ?", back: "already = déjà (affirmatif) · yet = pas encore / déjà ? (négatif & questions, en fin) · just = à l'instant.", chapter: "perfect" },
