...
(function () {
  ...
  var MITO = {
    ...
    phases: [
      { cap: '<b style="color:#7c3aed">Prophase</b> — les chromosomes se condensent (forme en X = 2 chromatides-sœurs). L\'enveloppe du noyau disparaît.',
        extras: cell(170, 150, 102) + nuc(170, 150, 64), pos: { b1: [142, 150], b2: [142, 150], r1: [206, 150], r2: [206, 150] } },
      { cap: '<b style="color:#7c3aed">Métaphase</b> — les chromosomes s\'alignent au milieu (plaque équatoriale).',
      ...
      { cap: '<b style="color:#7c3aed">Anaphase</b> — les <b>chromatides-sœurs se séparent</b> et partent vers les 2 pôles opposés.',
        extras: cell(170, 150, 102) + poles(), pos: { b1: [170, 74], r1: [170, 100], b2: [170, 226], r2: [170, 200] } },
      { cap: '<b style="color:#7c3aed">Télophase</b> — 2 noyaux se reforment, puis la cellule se coupe (<b>cytodiérèse</b>).',
  ...
  var MEIO = {
    ...
    phases: [
      ...
      { cap: '<b style="color:#7c3aed">Métaphase I</b> — les paires d\'homologues s\'alignent ensemble au centre.',
        extras: cell(170, 150, 102) + poles(), pos: { m1: [154, 150], m2: [154, 150], p1: [188, 150], p2: [188, 150] } },
      { cap: '<b style="color:#7c3aed">Anaphase I (réductionnelle)</b> — les chromosomes <b>HOMOLOGUES se séparent</b>. ⚠️ C\'est LA différence avec la mitose (2n → n).',
      ...
      { cap: '<b style="color:#7c3aed">2ᵉ division</b> (comme une mitose) — dans chaque cellule, les <b>chromatides-sœurs se séparent</b>.',
