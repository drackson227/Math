...
const CACHE = 'mathsgr2-v106';
const CORE = [
  './', './index.html', './style.css', './enhancements.css',
  './data.js', './content.js', './script.js',
  './auth.js', './chat.js', './multiplayer.js', './stats.js', './notes.js', './search.js', './generator.js', './subjects.js', './subject-chimie.js', './subject-bio.js', './subject-geo.js', './subject-eco.js', './subject-histoire.js', './subject-francais.js', './subject-anglais.js', './subject-neerlandais.js', './answersheet.js', './gestures.js', './bat.js', './shortcuts.js', './backtotop.js',
